    ...
    <div class="row" style="padding-top: 45px;height: 75%">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="${pageContext.request.contextPath}/query_user" class="btn list-group-item" style="background-color:red;color: white">超管信息</a>
                ...
                <div align="center" style="padding-top: 25px;">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="background: red">
                            ...
                            <form method="get" action="query_user">
                                <a class="btn btn-primary" href="add_user">添加</a>
                                <input name="query" type="submit" value="查询" class="btn btn-success">
                                Username: <input name="query_username" type="text" style="height: 20px;width: 100px">
                                Password:<input name="query_password" type="text" style="height: 20px;width: 100px">
                            </form>
                        ...
                        <c:otherwise>
                            <c:forEach var="u" items="${res}">
                                <tr>
                                    ...
                                    <td>${u.password}</td>
                                    <td>
                                        <a class="btn btn-warning" href="update_user?update_user_username=${u.username}">更新</a>

                                    </td>
                                    <td>

                                        <a class="btn btn-danger" onclick="delete_user('${u.username}','${u.password}')">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:otherwise>
